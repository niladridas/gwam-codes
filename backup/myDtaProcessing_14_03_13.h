...
protected:
    ...
    typename Output<criticTorque_type>::Value* test_torqueValue;
private:
...
public:
    myDataProcessing(double ts=1.0,const std::string& sysName = "myDataProcessing") :
        ...
        costOutput(this, &costOutputValue), jtOutput(this, &JtOutputValue), jpOutput(this, &prosJpOutputValue),jvOutput(this, &prosJvOutputValue),
       stateOutput(this, &stateOutputValue), test_torqueOP(this, &test_torqueValue), rearrStateOutput(0.0), Cost(0.0), Q(Eigen::Matrix4d()), R(Eigen::Matrix2d()),
       systemStates(0.0),test_torque(0.0), torque(Eigen::Vector2d()), TS_(ts)
...
protected:
    ...
    virtual void operate()
    {
      ...
      test_torque[0]=jtCurrent[1];
      test_torque[1]=jtCurrent[3];
