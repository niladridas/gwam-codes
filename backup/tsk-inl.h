...
Wvec(Eigen::Matrix<double, nR*(xDim*(xDim+1)/2), 1>()), delWx(Eigen::Matrix<double, xDim, nR*(xDim*(xDim+1)/2)>()), ruleBaseFlag(false),
delVdelX(Eigen::Matrix<double, xDim,1>()), model_A(Eigen::Matrix<double, xDim, xDim>()), model_B(Eigen::Matrix<double, xDim, uDim>()), M(Eigen::Matrix<double, xDim/2, xDim/2>()),
C(Eigen::Matrix<double, xDim/2, xDim/2>())
{
	...
	Sam::readFile(fnameFuz, fuzData, trFuz, tcFuz);
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		Sam::readFile(fnameConsModel, consDataModel, trConsModel, tcConsModel);
	...
	//	std::cout<<centers<<std::endl<<"==============================================="<<std::endl<<sigmas<<std::endl<<"==============================================="<<std::endl;
		...
		Sam::readFile(fnameConsCost, consDataCost, trConsCost, tcConsCost);
...
//
//		if(trCons!=nR*(xDim*(xDim+1)/2) || tcCons!=1){
//					std::cout<<"File "<<cons<<" is not proper for consequent params"<<std::endl;
//					exit(EXIT_FAILURE);
//				}
