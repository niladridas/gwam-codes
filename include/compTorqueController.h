...
public:
	   ...
	   System::Input<unitless_type_jp> posErrorIn, posErrorDotIn, refAccIn;
...
protected:
	...
	double T_s;
	InputType1  currentJp, prevJp;
	InputType2  currentJv;
  ///////////////////////////////////////////////////////////////////////////////
  //Test for compTorqueController
  //=========================================================================
	unitless_type_jp intError, intErrorLimit, error_jp, error_1_jp,error_jv, error_1_jv;
	unitless_type_jp kp, ki, kd, pE, vE, refacc;
