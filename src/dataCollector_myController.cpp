...
template<size_t DOF>
  ...
  typedef typename myController_type::criticTorque_type ctriticTorque_type;
...
//  typedef systems::TupleGrouper<double, jp_type, jv_type, err_type, err_type, jt_type , ja_type> tg_type;
  typedef systems::TupleGrouper<double, jp_type, jv_type, err_type, err_type, jt_type, ja_type, bvec_type> tg_type;
  ...
  systems::connect(mm.mMat2DOutput, myCon.mMat2Dinp);
...
//  systems::connect(mg.BmatOutput2J,criticCon.bMat2Dinp);
  ...
  systems::connect(myCon.pEout,tg.template getInput<3>());
  systems::connect(myCon.vEout,tg.template getInput<4>());
//
  systems::connect(myCon.controlOutput, tg.template getInput<5>());
  systems::connect(changeUnits1.output, tg.template getInput<6>());
  systems::connect(bg.BmatAsVecOutput, tg.template getInput<7>());
//  systems::connect(myCon.criticconOp, tg.template getInput<1>());
//  systems::connect(myCon.criticconOp, tg.template getInput<4>());

  typedef boost::tuple<double, jp_type, jv_type, err_type, err_type, jt_type, ja_type, bvec_type> tuple_type;
