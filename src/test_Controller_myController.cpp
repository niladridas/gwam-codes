...
//	const uint NS=4;
	...
	typedef systems::TupleGrouper<double, jp_type, jv_type,  jt_type,criticTorque_type> tg_type;
...
//	 wam.supervisoryController.registerConversion(systems::makeIOConversion(criticon.referenceInput, criticon.controlOutput));
	...
	connect(criticon.criticconOp, tg.template getInput<4>());
	typedef boost::tuple<double, jp_type, jv_type,  jt_type, criticTorque_type> tuple_type;
